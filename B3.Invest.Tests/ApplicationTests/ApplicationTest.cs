...
public class ApplicationTest
{
    ...
    public void Execute_ReturnsExpectedResponse()
    {
        ...
        var useCase = new CalculateInvestmentUseCase(mockCalculator.Object);
        ...
        mockCalculator.Verify(c => c.CalculateGross(It.Is<Investment>(i => i.InitialAmount == 1000m && i.Months == 12)), Times.Once);
        mockCalculator.Verify(c => c.CalculateNet(It.Is<Investment>(i => i.InitialAmount == 1000m && i.Months == 12)), Times.Once);
    }
}
